...
export default function userDeviceInfo(id) {
  ...
  if (isDesktop.linux()) {
    $id.innerHTML += `<p>Descarga nuestro software para Linux</mark></p>`;
  }

  if (isDesktop.mac()) {
    $id.innerHTML += `<p>Descarga nuestro software para Mac OS</mark></p>`;
  }

  if (isDesktop.windows()) {
    $id.innerHTML += `<p>Descarga nuestro software para windows</mark></p>`;
  }

  // Redirecciones
  if (isMobile.android()) {
    window.location.href = 'https://damianvigo.com';
  }
}
